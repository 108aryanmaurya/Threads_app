          ...
          <FormItem className='flex items-center gap-4'>
            ...
            >{
              field?.value?(
                ...
                <Image   src={field?.value} alt='profile_photo' width={96} height={96} priority className='rounded-full object-contain'></Image>
              ):
              (

                <Image   fill src="/assets/profile.svg" alt='profile_photo'   className=' object-contain'></Image>
              )
